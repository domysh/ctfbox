...
def check_sla():
    ...
    added_article = shell_article(
        test_article_title,
        test_article_description,
        test_article_price,
        test_article_secret,
    )
    ...
    if (
        ...
        or article["description"] != test_article_description
        or article["price"] != test_article_price
    ):
...
def put_flag():
    ...
    checklib.save_flag_data(flag, {"article": article, "user": flag_user})
